...
st.set_page_config(layout="wide", page_title="HAVEN - Explore")
...
with st.container():
    ...
    with col2:
        ...
        search_query = st.text_input("", placeholder="Search campaigns by title or description", key="search_bar_explore")
        st.markdown("</div>", unsafe_allow_html=True)
        ...
        # Directly embedding the provided HTML for category buttons
        # The onclick event will update the Streamlit session state, triggering a rerun and filtering
        st.markdown(f"""
